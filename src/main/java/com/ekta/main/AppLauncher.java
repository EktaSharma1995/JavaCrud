	...
	public static void main(String[] args) {
		...
		for (;;) {
			...
			if (isChoiceCreate(choice)) { // string comparison is by equals or equalsIgnoreCase.							
				...
				int sin = Integer.parseInt(keyBoard.nextLine());
				...
				int idForReference = Integer.parseInt(keyBoard.nextLine());
				...
				for (Employee empl : employeeDbForLauncher) { // Enhanced for
																// loop.
					System.out.println(empl); // Printing each record retrieved
												// using retrieveAll() method
												// stored in object empl.
				}
				...
				String fieldToBeUpdated = keyBoard.nextLine();
